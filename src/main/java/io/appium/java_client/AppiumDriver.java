...
public class AppiumDriver extends RemoteWebDriver implements
    ...
    protected static Capabilities ensurePlatformName(
    	...
    	Object originalPlatformName =  originalCapabilities.getCapability(PLATFORM_NAME);
    	
    	String currentName = "";
    	
    	if(null != originalPlatformName) {
    		if(originalPlatformName instanceof String ) {
    			currentName = (String) originalPlatformName;
    		}
    		
    		if(originalPlatformName instanceof Platform ) {
    			
    			Platform platformObject = (Platform) originalPlatformName;
    			currentName = platformObject.name();
    		}
    ...
    protected void startSession(Capabilities capabilities) {
        ...
        rawCapabilities.remove(CapabilityType.PLATFORM_NAME);
