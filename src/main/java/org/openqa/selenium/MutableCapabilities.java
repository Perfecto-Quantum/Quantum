...
@Override
  public Object getCapability(String capabilityName) {
	  ...
	  Object capValue = caps.get(capabilityName);
	  
	  if(null==capValue) {
		  
		  Set<Entry<String,Object>> capEntries = caps.entrySet();
		  
		  for(Entry<String,Object> capEntry : capEntries) {
			  Object capEntryValue = capEntry.getValue();
			  
			  if(capEntryValue instanceof Map<?, ?>) {
				  Map<String,Object> extraCaps = (Map<String,Object>)capEntryValue;
				  if(extraCaps.containsKey(capabilityName)) {
					  capValue = extraCaps.get(capabilityName); 
					  break;
				  }
			  }
