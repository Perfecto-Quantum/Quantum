...
public class PerfectoApplicationSteps {
	 ...
	 * 
	 * @param application
	 *            the local or repository path, including directory and file name,
	 ...
	 * 
	 * @param version
	 *            the application version to verify
	 ...
	 * 
	 * @param orientation
	 *            the application orientation to verify, landscape or portrait
	 ...
	 * 
	 * @param orientation
	 *            the application orientation to check, landscape or portrait
	 */
	 ...
	 * 
	 * @param img
	 *            the repository path, including directory and file name, where to
	 *            locate the image
	 ...
	 *            the wait duration
	 * @param image
	 *            the image to wait for to appear
	 */
	 ...
	 *            the image repository file location
	 * @param name
	 *            the application name as it is displayed on the device screen
	 */
	 ...
	 *
	 * @param errorType
	 *            indicates why the authentication failed. May be authFailed,
