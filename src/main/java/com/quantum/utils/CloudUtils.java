...
public class CloudUtils {
    ...
    public static DesiredCapabilities getDeviceProperties() {
        return getDeviceProperties(ConfigurationUtils.getActualDeviceCapabilities(ConfigurationUtils.getBaseBundle()));
    }

    public static DesiredCapabilities getDeviceProperties(DesiredCapabilities desiredCapabilities) {
    ...
    public static List<ParameterValue> convertMapToInputParameters(Map<String, ?> mapValues) {
        ...
        inputParameters.add(new ParameterValue("availableTo", getCredentials(ConfigurationUtils.getDesiredDeviceCapabilities()).getUser()));
    ...
    public static Iterator<Object[]> getConnectedDevices(Map<String, ?> mapValues) {
        ...
        CloudUtils.getDeviceList(CloudUtils.convertMapToInputParameters(mapValues)).forEach(deviceResult -> deviceResultList.add(new Object[]{deviceResult}));
    ...
    public static boolean isDeviceAvailable() {
        ...
        try {
            List<DeviceResult> deviceList = getDeviceList(convertMapToInputParameters(ConfigurationUtils.getDesiredDeviceCapabilities().asMap()));
